  ...
  return (
    <div className={darkmode=='dark' ? 'dark' : 'light'}>
      <div className="grid grid-cols-5 h-screen text-center">
        <select onChange={(event) => setDarkMode(event.target.value)} className="fixed dark:bg-zinc-800 dark:text-white bg-red-100 text-zinc-800  text-sm bottom-0 p-5">
        ...
        <div className="col-span-4 p-10">
          <h1 className="text-4xl font-semibold bg-clip-text text-transparent leading-relaxed bg-gradient-to-r from-pink-700 to-violet-700"
          ...
          <div ref={scrollToAns} className="container h-110 p-4 overflow-auto custom-scrollbar">
        ...
        border border-zinc-600 flex h-14">
